...
module "cloud_armor" {
  ...
  security_rules = {
    allow_whitelisted_ip_ranges = {
      ...
      src_ip_ranges = ["190.210.69.12/32"]
      preview       = false
    }
    ...
    redirect_project_drop = {
      action        = "redirect"
      priority      = 12
      description   = "Redirect IP addresses from project drop"
      src_ip_ranges = ["190.217.68.212/32", "45.116.227.69/32"]
    ...
    rate_ban_project_dropthirty = {
      ...
      priority      = 13
      description   = "Rate based ban for addresses from project dropthirty"
      src_ip_ranges = ["190.217.68.213/32", "45.116.227.70/32"]
      rate_limit_options = {
    ...
    throttle_project_droptwenty = {
      ...
      src_ip_ranges = ["190.217.68.214/32", "45.116.227.71/32"]
      rate_limit_options = {
        exceed_action                        = "deny(502)"
        rate_limit_http_request_count        = 10
        rate_limit_http_request_interval_sec = 60
